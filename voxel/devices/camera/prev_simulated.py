...
class SimulatedCamera(BaseCamera):
    ...
    def image_size_px(self) -> Vec2D:
        """Get the image size of the camera in pixels.

        :return: The image size of the camera in pixels
        :rtype: Vec2D
        """
        return Vec2D(self._width_px, self._height_px) // self._binning
