...
def test_trigger_settings(real_camera):
    ...
    for mode in trigger_mode_options:
        ...
        assert (real_camera.trigger_mode == mode
                or mode not in real_camera.trigger_mode.options)
        ...
        for source in trigger_source_options:
            ...
            assert (real_camera.trigger_source == source
                    or source not in real_camera.trigger_source.options)
            ...
            for polarity in trigger_polarity_options:
                ...
                assert (real_camera.trigger_polarity == polarity
                        or polarity not in real_camera.trigger_polarity.options)
                ...
                for active in trigger_active_options:
                    ...
                    assert (real_camera.trigger_active == active
                            or active not in real_camera.trigger_active.options)
