...
def test_query_delimination_prop(mock_camera):
    ...
    expected_calls = [
        call('Width.Min'), call('Width.Max'), call('Width.Inc'),
        call('Height.Min'), call('Height.Max'), call('Height.Inc'),
        call('ExposureTime.Min'), call('ExposureTime.Max'), call('ExposureTime.Inc')
    ]
