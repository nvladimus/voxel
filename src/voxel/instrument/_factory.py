...
from ._config import InstrumentConfig, InstanceSpec
from .channel import VoxelChannel
from .device import VoxelDevice
from .file_transfers import VoxelFileTransfer
from .instrument import VoxelInstrument
from .nidaq import VoxelNIDAQ
from .nidaq.simulated import SimulatedNIDAQ
from .nidaq.task import DAQTask, DAQTaskType
from .writers import VoxelWriter
...
class InstrumentFactory:
    ...
    def _create_instance(self, instance_name: str, instances_spec: Dict[str, InstanceSpec], register: Dict[str, Any]):
