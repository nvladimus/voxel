...
class VoxelAcquisition:
    ...
    @classmethod
    def load_from_yaml(cls, instrument: "VoxelInstrument", file_path: str) -> "VoxelAcquisition":
        with open(file_path) as f:
            yaml = YAML()
            data = yaml.load(f)
